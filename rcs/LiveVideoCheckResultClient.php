<?php
class LiveVideoCheckResultClient {

    const PROJECT_ID = 'YOUR_PROJECT_ID_GOES_HERE';
    const SECRET_KEY = 'YOUR_SECRET_KEY_GOES_HERE';
    const REQ_URL = 'https://vsafe.ilivedata.com/api/v1/livevideo/check/result';
    const HOST = 'vsafe.ilivedata.com';
    const PATH = '/api/v1/livevideo/check/result';
...
$videocheckresult = new LiveVideoCheckResultClient();
