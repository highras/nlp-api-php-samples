<?php
class VideoCheckSubmitClient {

    const PROJECT_ID = 'YOUR_PROJECT_ID_GOES_HERE';
    const SECRET_KEY = 'YOUR_SECRET_KEY_GOES_HERE';
    const REQ_URL = 'https://vsafe.ilivedata.com/api/v1/video/check/submit';
    const HOST = 'vsafe.ilivedata.com';
    const PATH = '/api/v1/video/check/submit';
...
$videochecksubmit = new VideoCheckSubmitClient();
$video = 'http://edge.ivideo.sina.com.cn/34463529803.mp4?KID=sina,viask&Expires=1597852800&ssig=6po29lqbTn&reqid=';
