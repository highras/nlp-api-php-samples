<?php
class AudioCheckResultClient {

    const PROJECT_ID = 'YOUR_PROJECT_ID_GOES_HERE';
    const SECRET_KEY = 'YOUR_SECRET_KEY_GOES_HERE';
    const REQ_URL = 'https://asafe.ilivedata.com/api/v1/audio/check/result';
    const HOST = 'asafe.ilivedata.com';
    const PATH = '/api/v1/audio/check/result';
...
$audiocheckresult = new AudioCheckResultClient();
