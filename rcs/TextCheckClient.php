<?php
class TextCheckClient {

    const PROJECT_ID = 'YOUR_PROJECT_ID_GOES_HERE';
    const SECRET_KEY = 'YOUR_SECRET_KEY_GOES_HERE';
    const REQ_URL = 'https://tsafe.ilivedata.com/api/v1/text/check';
    const HOST = 'tsafe.ilivedata.com';
    const PATH = '/api/v1/text/check';

    public function check($text, $userId) {
        // UTC Time
...
$textcheck = new TextCheckClient();
$text = 'fuck';
$textcheck->check($text, '12345678');
