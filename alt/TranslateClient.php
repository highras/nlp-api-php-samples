...
class TranslateClient {
    ...
    const REQ_URL = 'https://translate.ilivedata.com/api/v2/translate';
    const HOST = 'translate.ilivedata.com';
    const PATH = '/api/v2/translate';

    public function translate($sourceLanguage, $targetLanguage, $sentence) {
        // UTC Time
...
$translateClient->translate('en', 'zh-CN', 'Hello world!');
$translateClient->translate('ja', 'en', 'こんにちは');
