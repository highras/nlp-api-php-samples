...
class SpeechTranslateClient {
    ...
    const PROJECT_ID = 'YOUR_PID_GOES_HERE';
    const SECRET_KEY = 'YOUR_SECRETKEY_GOES_HERE';
    const REQ_URL = 'https://speech.ilivedata.com/api/v1/speech/translate';
    const HOST = 'speech.ilivedata.com';
    const PATH = '/api/v1/speech/translate';

    public function speechTranslate($audio, $speechLanguageCode, $textLanguageCode, $userId) {
        // UTC Time
