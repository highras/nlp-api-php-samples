<?php
class SpeechRecognizeClient {

    const PROJECT_ID = 'YOUR_PROJECT_ID_GOES_HERE';
    const SECRET_KEY = 'YOUR_SECRET_KEY_GOES_HERE';
    const REQ_URL = 'https://asr.ilivedata.com/api/v1/speech/recognize';
    const HOST = 'asr.ilivedata.com';
    const PATH = '/api/v1/speech/recognize';

    public function recognize($audio, $languageCode, $userId, $profanityFilter) {
        // UTC Time
...
$speech = new SpeechRecognizeClient();
...
$speech->recognize($audio, 'zh-CN', '12345678', 1);
$speech->recognize($audio, 'zh-CN', '12345678', 0);
